  ...
  UserInterface = (function() {
    ...
    UserInterface.prototype.updateLayerList = function(layers, selectedIndex) {
      ...
      for (i = _i = 0, _ref = layers.length; 0 <= _ref ? _i < _ref : _i > _ref; i = 0 <= _ref ? ++_i : --_i) {
        l = layers[i];
        visibility_icon = this.viewSettings.visibilityIconEnabled ? "<div class='visibility_icon' title='Hide/show image'><i class='fa fa-eye'></i></div>" : '';
        deletion_icon = this.viewSettings.deletionIconEnabled ? "<div class='deletion_icon' title='Remove this layer'><i class='fa fa-trash-o'></i></div>" : '';
        download_icon = true ? "<div class='download_icon' title='Download this image'><i class='fa fa-save'></i></div>" : '';
    ...
    UserInterface.prototype.updateLayerVisibility = function(visible) {
      ...
      for (i = _i = 0, _ref = visible.length; 0 <= _ref ? _i < _ref : _i > _ref; i = 0 <= _ref ? ++_i : --_i) {
        if (visible[i]) {
          _results.push($('.visibility_icon>i').eq(i).removeClass('fa-eye-slash').addClass('fa-eye'));
        } else {
          _results.push($('.visibility_icon>i').eq(i).removeClass('fa-eye').addClass('fa fa-eye-slash'));
        }
      }
      return _results;
    };
