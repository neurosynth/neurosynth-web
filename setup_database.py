...
from nsweb.settings import SQLALCHEMY_DATABASE_URI, DEBUG, DEBUG_WITH_APTANA, DATA_DIR, FEATURE_DATABASE, PICKLE_DATABASE, IMAGE_DIR, FEATURE_FREQUENCY_THRESHOLD
